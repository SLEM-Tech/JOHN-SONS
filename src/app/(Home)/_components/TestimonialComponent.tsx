...
const TestimonialCarousel: React.FC = () => {
  ...
  return (
    <div className="relative py-16 bg-background text-white overflow-hidden">
          ...
          {testimonials.map((testimonial, index) => (
            <div
              ...
              <div className=" p-8 h-full flex flex-col justify-center">
                <FaQuoteLeft className="text-4xl text-white mb-6" />
                ...
                <div className="mt-auto">
                  ...
                  <p className="text-md text-white">{testimonial.company}</p>
                </div>
              </div>
            </div>
          ))}
