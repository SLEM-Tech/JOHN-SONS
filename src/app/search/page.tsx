...
const Page = () => {
  ...
  return (
    <AppLayout className="pt-32">
      <main className="bg-white flex flex-col items-center relative justify-center w-full  pt-40 slg:pt-44 xl:pt-5 mx-auto max-w-[1156px] min-h-[50vh] mb-20 px-4 lg:px-2">
        {ProductsTotal === 0 ? (
          <div className="">
          ...
          <>
            <div className="flex w-full py-3 px-5 bg-primary absolute top-0 text-base">
              Total&nbsp;
