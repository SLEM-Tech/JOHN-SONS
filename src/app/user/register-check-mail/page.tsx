...
const Page = () => {
  ...
  return (
    <AppLayout>
      <main className="pt-32 mb-20 md:mb-44 flex items-center justify-center px-3 sm:px-8 md:px-0">
        <div className="flex flex-col items-center justify-center text-center bg-white w-full md:w-[32rem] py-8 md:py-16 px-2 shadow-lg rounded-xl gap-2 md:gap-5">
          ...
          <h3
            className="hover:underline text-sm md:text-base cursor-pointer hover:text-primary bg-background p-3 rounded-xl text-white"
