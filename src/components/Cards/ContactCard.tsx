...
const ContactCard = ({
  ...
  return (
    <div className="flex bg-white flex-col w-[15rem] slg:w-[18rem] xl:w-[23rem] border-[1px] shadow-md rounded-md py-5 xl:py-10 items-center justify-center text-center gap-2 slg:gap-4 px-4 xl:px-1">
      {icon}
