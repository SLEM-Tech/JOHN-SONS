...
const ProductCard1 = ({ product }: ProductCardProps) => {
  ...
  return (
    <Link
      ...
      className="rounded-xl p-6 transition flex flex-col bg-white/80 shadow-xl shadow-white">
      {/* Image Section */}
      ...
      <div className="flex-[0.3] flex flex-col">
        ...
        <div className="mt-auto">
          ...
          <button
            ...
            className="w-full bg-tertiary-100 text-black py-2 rounded-md transition"
