...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`flex slg:flex-col w-full justify-center items-center bg-white py-5 z-50 transition drop-shadow-md fixed top-0 ${
          navbar ? "" : " "
        }`}>
        {/* Desktop */}
        <div className="hidden slg:grid grid-cols-4 items-center w-full py-1 max-w-[1200px] z-30 px-5 xl:px-0">
          ...
          <div className="flex justify-center h-10 col-span-2">
            <input
              ...
              className="text-base text-black/70 px-4 w-[300px] xl:w-[400px] rounded-full py-1 border border-[#ccc]  outline-none focus:border-primaryColor-100 focus:ring-primaryColor-100 focus:ring-1 transition"
              value={searchValue}
              ...
              <div
                ...
                {typeof window !== "undefined" && (
                  <div className="flex relative justify-center items-center rounded-full w-12 h-12 p-2 text-sm border">
                    ...
                    <CartIconSvg className="fill-primary" />
                  </div>
                )}
              ...
              <div className="flex items-center gap-2">
                <Dropdown>
                  <DropdownTrigger className="">
                    <button
                      type="button"
                      className="bg-white border border-black hover:bg-black cursor-pointer transition-[.4] group text-black text-xl group-hover:text-white rounded-full p-0 size-8">
                      {baseCurrency?.symbol}
                    </button>
                  </DropdownTrigger>
